...
* Darshal Shetty (dcshetty): Wednesdays 1:30-2:30pm, Fridays 2-3pm, in Luddy 3014 (or nearby).
...
Sep. 24 | [Conditionals: Select Instr., Reg. Alloc., Opt. Jumps](https://docs.google.com/presentation/d/1Zcq1OpvmiMcHDkSZ0qjF2mdYNaov0t5R4qF0h66ryV8/edit?usp=sharing) | Register Allocationsubmit in [Racket](https://autograder.luddy.indiana.edu/web/project/1284) or [Python](https://autograder.luddy.indiana.edu/web/project/1271)
...
Oct. 8 | [Tuples and Garbage Collection](https://docs.google.com/presentation/d/1LTyqurU5c1MfzBJAjuuLJKZYAYqyjLggaZn-MIV4ocg/edit?usp=sharing) | Booleans and Conditionals
...
Oct. 22 | Review for Midterm Exam | Loops
...
Nov. 5  | Compiling Functions, cont'd | Tuples
